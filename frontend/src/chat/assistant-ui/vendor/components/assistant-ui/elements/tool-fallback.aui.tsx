...
function ToolFallbackApproval({
  ...
  // Local modification (vendor/README.md): the registry's copy is written
  // against a newer @assistant-ui/react than the one pinned here, whose
  // `ToolApproval` has no `dismissible` field yet. Read as an optional
  // property it is simply absent, which is how upstream behaves for an
  // approval that does not set it. Dropped at the re-sync that catches up.
  const dismissible =
    question &&
    respondToApproval != null &&
